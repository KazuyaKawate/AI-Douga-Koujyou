@echo off
REM ================================================================
REM  check_environment.bat  --  AI-Douga-Koujyou v4.1 env checker
REM
...
title Check Environment - AI-Douga-Koujyou

echo.
echo  ============================================
echo   AI-Douga-Koujyou v4.1 - Environment Check
echo  ============================================
echo.
...
if exist "venv\Scripts\activate.bat" (
    ...
    REM -- Streamlit (requires active venv)
    echo  [Streamlit]
    streamlit --version 2>&1 || echo    Not installed  ^(pip install streamlit^)
    echo.

    REM -- OpenAI (requires active venv)
    echo  [OpenAI]
